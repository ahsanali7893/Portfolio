...
const Contact = (props: Props) => {
  return (
    <section id="contact">
      <div className="container py-16 md:py-20 max-w-xl mx-auto">
        ...
        <form className="mx-auto w-full pt-10 sm:w-3/4">
          <div className="flex flex-col md:flex-row">
            <input
              className="mr-3 w-full rounded border border-gray-200 px-4 py-3 font-body text-black md:w-1/2 lg:mr-5"
              type="text"
              placeholder="Name"
              id="name"
            />
            <input
              className="mt-6 w-full rounded border border-gray-200 px-4 py-3 font-body md:ml-3 md:mt-0 text-black md:w-1/2 lg:ml-5"
              type="text"
              placeholder="Email"
              id="email"
            />
          ...
          <textarea
            className="mt-6 w-full rounded border border-gray-200 px-4 py-3 font-body text-black md:mt-8"
            placeholder="Message"
            id="message"
            cols={30}
            rows={10}
